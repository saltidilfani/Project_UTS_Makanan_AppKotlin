...
class DetailMakanan : AppCompatActivity() {
    ...
    private lateinit var imgDetaiMakanan: ImageView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        imgDetaiMakanan = findViewById(R.id.imgDNMakanan)

        //get data
        var detailText = intent .getStringExtra("nama")
        val detailImg = intent.getIntExtra("image", 0)

        //set data ke widget
        txtDetailMakanan.setText(detailText)
        imgDetaiMakanan.setImageResource(detailImg)
